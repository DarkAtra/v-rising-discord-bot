    ...
    override suspend fun handle(interaction: ChatInputCommandInteraction) {
        ...
        interaction.deferEphemeralResponse().respond {
            embed {
                ...
                description = when {
                    !server.apiEnabled && raidFeed.status == Status.ACTIVE -> "This feature is currently disabled since no ${ServerApiHostnameParameter.NAME} and/or ${ServerApiPortParameter.NAME} is set for this server."
                    else -> null
                }
